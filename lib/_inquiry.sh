...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao instalador Whats Ticket, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar o Whats Ticket\n"
  printf "   [2] Atualizar o Whats Ticket\n"
  printf "\n"
  read -p "> " option
