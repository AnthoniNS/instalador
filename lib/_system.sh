...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código Whats Ticket...${GRAY_LIGHT}"
  printf "\n\n"
  ...
  sudo su - deploy <<EOF
  git clone https://github.com/AnthoniNS/whatsticket.git  /home/deploy/${instancia_add}/
EOF
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema Whats Ticket...${GRAY_LIGHT}"
  printf "\n\n"
